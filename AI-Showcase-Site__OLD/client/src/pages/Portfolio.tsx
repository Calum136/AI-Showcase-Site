    ...
    <Layout>
      <div className="space-y-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h1 className="text-4xl font-bold font-display mb-4">Selected Work</h1>
        ...
        >
          {items.map((project) => (
            <motion.div key={project.id} variants={itemAnim}>
              <Card className="h-full flex flex-col overflow-hidden border-border/50 shadow-lg hover:shadow-xl transition-all duration-300 group">
                <div className="h-56 bg-muted overflow-hidden relative">
                  {/* Unsplash fallback if no imageUrl provided */}
                  <img 
